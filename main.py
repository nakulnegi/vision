...
window.iconphoto(False, tk.PhotoImage(file='recording.png'))
window.geometry('1080x700')


frame1 = tk.Frame(window)

label_title = tk.Label(frame1, text="VISION IS WATCHING YOU", fg='red' )
...
btn6_image = btn6_image.resize((60,60), Image.ANTIALIAS)
...
btn7_image = Image.open('icons/person.png')
...
btn2 = tk.Button(frame1, text='Rectangle', height=90, width=200, fg='blue', command=rect_noise, compound='left', image=btn2_image)
btn2['font'] = btn_font
btn2.grid(row=3, pady=(20,10), column=3, padx=(20,5))

btn_font = font.Font(size=25)
btn3 = tk.Button(frame1, text='Motion', height=90, width=180, fg='blue', command=noise, image=btn3_image, compound='left')
btn3['font'] = btn_font
btn3.grid(row=5, pady=(20,10))

btn4 = tk.Button(frame1, text='Recording', height=90, width=220, fg='blue', command=record, image=btn4_image, compound='left')
btn4['font'] = btn_font
